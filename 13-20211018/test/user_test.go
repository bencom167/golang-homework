...
func Test_GetUserById(t *testing.T) {
	user, err := repo.GetUserById("eq5tyxg4")
	assert.Nil(t, err)
...
func Benchmark_GetAllUser(b *testing.B) {
	for i := 0; i < b.N; i++ {
		_, _ = repo.GetAllUser() // 1104, 1093, 1077 || 1449, 1446, 1446 || 1398, 1402,
	}
}

func Benchmark_GetUserById(b *testing.B) {
	for i := 0; i < b.N; i++ {
		_, _ = repo.GetUserById("eq5tyxg4") // 541, 574, 589 || 1497, 1502, 1508 || 1382
	}
}
...
func Benchmark_UpdateUser(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		_, _ = repo.UpdateUser("eq5tyxg4", req) // 308, 288, 306 || 1396, 1418, 1407
	}
}
